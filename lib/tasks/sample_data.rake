...
def make_jobs
  ...
  23.times do
    users.each do |user| 
      ...
      user.jobs.create(title: title, body: body, job_type: job_type, job_category: job_category, city: city, company: company, published: Random.rand(100).days.ago, valid_after: valid_after )
    end
  end
end
